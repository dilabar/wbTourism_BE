...
class ProductPageController extends Controller
{
    ...
    public function heritage(Request $request)
    {
        $banner_list = collect([]);
        $product_list=collect([]);
        $event_list=collect([]);
        return view('product/heritage',
        [
    ...
    public function details(Request $request)
    {
        ...
        $banner_db = Item::where('_id', $id)->where('is_active', 1)->where('is_approved', 1)->where('type', 'product')->first();
        $details_db = Item::where('main_product_id', $id)->where('is_active', 1)->where('is_approved', 1)->where('type', 'detailpage')->first();
        ...
        $vedio_image_db=Item::where('is_active', 1)->where('is_approved', 1)->where('_id', $details_db->vedio_image)->where('type', 'Image')->first();
        ...
        $details_db->title=$banner_db->name;
