...
@section('content')
    <section class="pt-100">
        <div class="section-title title-style">
            <h2>Festival Durga Puja</h2>
        </div>
        <div class="col-md-10 offset-1">
            <div class="event_tourism_gallery">
                <ul id="gallery">
                    @isset($durgapuja_image_list)
                        @foreach ($durgapuja_image_list as $item)
                            <li>
                                <div class="overLay">
                                    ...
                                    @if ($item->youtube_link)
                                        <iframe src="{{ $item->youtube_link }}" frameborder="0" height="250"  allowfullscreen></iframe>
                                    @endif
