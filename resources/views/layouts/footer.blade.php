...
<script>
    ...
    $(".smolNav").on("click", function() {
        ...
        if (width > 768) {
            $("#hide-menu1,#hide-menu2,#hide-menu3,#hide-menu4,#hide-menu5,#hide-menu6,#hide-menu7,#hide-menu8").hide();
        } else {
          $("#hide-menu1,#hide-menu2,#hide-menu3,#hide-menu4,#hide-menu5,#hide-menu6,#hide-menu7,#hide-menu8").show();
        }
        // var $drillDown = $("#menushow");
    });
</script>
@yield('script')
