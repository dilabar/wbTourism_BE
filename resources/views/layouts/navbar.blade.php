               ...
               <nav class="navbar navbar-expand-md navbar-light">
                  ...
                  <div class="collapse navbar-collapse mean-menu">
                     <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                           <a href="#" class="nav-link toggle">Most Popular<i class='bx bxs-chevron-down'></i></a>
                           <ul class="dropdown-menu" style="width: 300px;">
                              ...
                              <li class="nav-item ">
                                 ...
                                 <div class="d-flex flex-row m-1 border" >
                                    <img class="img-responsive" src="{{(getImage($p_item->banner_image))}}" alt="" width="60" height="50">
                        ...
                        <li class="nav-item">
                           <a href="#" class="nav-link toggle">E-Booking<i class='bx bxs-chevron-down'></i></a>
                        ...
                        <li class="nav-item">
                           <a href="#" class="nav-link toggle">Gallery<i class='bx bxs-chevron-down'></i></a>
                           <ul class="dropdown-menu">
                              <li class="nav-item">
                        ...
                        <li class="nav-item">
                           <a href="#" class="nav-link toggle">WBTDCL<i class='bx bxs-chevron-down'></i></a>
                           <ul class="dropdown-menu">
                              <li class="nav-item">
                        ...
                        <li class="nav-item">
                           <a onclick="location.href='javascript:void(0);'" class="smolNav ght" class="ght"><i
                  ...
                  <a class="navbar-brand" href="index.html">
                     <img src="{{asset('assets/img/logo/wb_logo.png')}}" class="logo-wb" alt="Logo" width="50" height="50">
