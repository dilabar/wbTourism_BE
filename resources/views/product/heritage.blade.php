...
@section('content')
  ...
  <div class="page-title-area ptb-100">
    ...
    <div class="bg-image">
      <img src="../assets/img/top_product/banner/heritage.jpg" alt="Demo Image">
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-12">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link " id="how-to-reach-tab" data-bs-toggle="tab" data-bs-target="#how-to-reach"
                type="button" role="tab" aria-controls="how-to-reach" aria-selected="true">How to reach</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link " id="attractions-tab" data-bs-toggle="tab" data-bs-target="#attractions"
                type="button" role="tab" aria-controls="attractions" aria-selected="true">Attractions</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link " id="stay-tab" data-bs-toggle="tab" data-bs-target="#stay" type="button"
                role="tab" aria-controls="stay" aria-selected="true">Stay</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link " id="nearby-amenties-tab" data-bs-toggle="tab" data-bs-target="#nearby-amenties"
                type="button" role="tab" aria-controls="nearby-amenties" aria-selected="true">Nearby Amenties</button>
            </li>
          ...
          <div class="tab-content pt-70" id="myTabContent">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="single-slider owl-carousel">
                    <div class="image mb-30 p-2">
                      <img src="../assets/img/top_product/heritage/DSC_2405.JPG" alt="Demo Image" />
                    </div>
                    <div class="image mb-30 p-2">
                      <img src="../assets/img/top_product/heritage/DSC_2450.JPG" alt="Demo Image" />
                    </div>
                ...
                <div class="row align-items-center">
                  <div class="col-md-4 col-sm-12">
                    <div class="image mb-30">
                      <img src="../assets/img/top_product/heritage/_AVI9594.jpg" alt="Demo Image" />
                    </div>
                  </div>
            ...
            <div class="tab-pane fade show" id="how-to-reach" role="tabpanel" aria-labelledby="how-to-reach-tab">
              <div class="tour_details_boxed">
                <h3 class="heading_theme">Lorem ipsum </h3>
                <div class="tour_details_boxed_inner">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita, laborum. Facilis voluptatem, ipsum, sit, dolor illo eligendi nam nisi expedita temporibus modi cum. Cupiditate, consequatur in repellat nisi ab dolorem?
                </div>
              </div>
            </div>
          ...
          <aside class="widget-area">
            ...
            <div class="widget widget-video mb-30">
              <div class="video-image">
                <img src="../assets/img/top_product/heritage/PHUNSHELONG IMG_3593 (2).jpg" alt="video" />
              </div>
