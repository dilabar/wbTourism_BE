            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="{{ url('/admin/books/list') }}" class="btn btn-info"> <i class="fas fa-list-ol"></i>
                            View Books</a>
                    </div>
                    <div class="row">
                        <div class="card col-lg-8 offset-lg-2">
                            <div class="card-header">
                                <h6 class="m-0 font-weight-bold ">Create Books</h6>
                            ...
                            <form class="contact100-form validate-form" action="{{ route('update') }}"
                                ...
                                <select class="form-select" name="type">
                                    <option value="Brochure" {{$details_db->type=='Brochure'?'selected':''}}>Brochure</option>
                                    <option  value="Leaflet" {{$details_db->type=='Leaflet'?'selected':''}}>Leaflet</option>
                                </select>
                                <div class="wrap-input100 validate-input" data-validate="Book Title">
                                    <input class="input100" type="text" name="name" placeholder="Book Title" value="{{$details_db->name}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1"
                                        ...
                                        <img src="{{$full}}" width="100" height="100"/>
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlFile1">Book Pdf Upload</label>
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1"
                                        name="book_pdf">
                                        <embed src="{{$pdf}}" type="application/pdf" width="100%" height="200px">
                                </div>

                                <input type="hidden" name="book_id" value="{{$details_db->_id}}" />
