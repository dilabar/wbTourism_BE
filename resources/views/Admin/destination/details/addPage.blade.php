        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form class="addpagefrm contact100-form validate-form" action="{{ route('addplace') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="destination_id" name="destination_id">
                                        @if (count($destination_list) > 0)
                                            ...
                                            @foreach ($destination_list as $b_item)
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="district_code" name="district_code">
                                        @if (count($d_list) > 0)
                                            <option value="0" selected>-- SELECT --</option>
                                            @foreach ($d_list as $d)
                                                <option value="{{ $d->district_code }}" class="text-uppercase">
                                                    {{ $d->district_name }}
                                                </option>
                                            @endforeach
                                        @endif
