                    ...
                    <div class="row">
                        <div class="card col-lg-8 offset-lg-2">
                            <div class="card-header">
                                <h6 class="m-0 font-weight-bold ">Create Consulates</h6>

                            </div>
                            <form class="contact100-form validate-form" action="{{ route('consulates.store') }}"
                                ...
                                <div class="wrap-input100 validate-input" data-validate="Office Name">
                                    <input class="input100" type="text" name="officename" placeholder="Office Name">
                                    <span class="focus-input100"></span>
                                </div>
