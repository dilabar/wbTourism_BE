            ...
            <div id="content">
                ...
                @if ($message = Session::get('success'))
                  ...
                  @endif
                    ...
                    <form class="contact100-form validate-form" action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                      <div class="wrap-input100 validate-input" data-validate="Product Name/Title">
                            <input class="input100" type="text" name="name" placeholder="Product Name/Title">
                       <span class="focus-input100"></span>
                      </div>
                      <div class="wrap-input100 validate-input" data-validate="Product Short Description">
                            <input class="input100" type="text" name="description" placeholder="Product Short Description">
                       <span class="focus-input100"></span>
                      </div>
                      ...
                      <div class="wrap-input100 validate-input" data-validate="Product Gradient">
                            <input class="input100" type="text" name="gradient" placeholder="Product Gradient">
                       <span class="focus-input100"></span>
                      </div>
