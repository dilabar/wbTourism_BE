            ...
            <div id="content">
                ...
                @if ($message = Session::get('success'))
                  ...
                  @endif
                    ...
                    <form class="contact100-form validate-form" action="{{ route('item.store') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="wrap-input100 validate-input" data-validate="Tab Code">
                            <input class="input100" type="text" name="tab_code" placeholder="Tab Code">
                       <span class="focus-input100"></span>
                      </div>
