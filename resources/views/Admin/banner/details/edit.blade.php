...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Edit Detail Page</h1>

					</div>

					<form class="addpagefrm contact100-form validate-form" action="{{ route('bannerdetaislupdate') }}"
						...
						<div id="ajax_template_content"></div>
						<div id="gallery_section"></div>
						<input type="hidden" name="_token" value="{{ csrf_token() }}" />
						<input type="hidden" name="detailspage_id" value="{{$edit_list->_id}}" />
	...
	<script type="text/javascript">
		$(document).ready(function () {
			$('#ajax_template_content').html(`{!!$html!!}`);
