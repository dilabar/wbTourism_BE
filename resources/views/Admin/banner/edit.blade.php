            ...
            <div class="container-fluid">
               ...
               <div class="row">
                  <div class="col-lg-12">
                     ...
                     <form class="contact100-form validate-form" action="{{ route('bannerupdate') }}" method="POST"
                        enctype="multipart/form-data">
                        {{-- @csrf   --}}
                        {{-- @method('PUT') --}}
                        <div class="wrap-input100 validate-input" data-validate="Banner Title">
                           <input class="input100" type="text" name="name" placeholder="Banner Name/Title" value="{{ $details_db->name }}">
                           <span class="focus-input100"></span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate="Banner Slogan">
                           <input class="input100" type="text" name="slogan" value="{{ $details_db->slogan}}" placeholder="Banner Slogan">
                           <span class="focus-input100"></span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate="Banner Short Description">
                           <input class="input100" type="text" name="description" value="{{ $details_db->short_desc}}"
                        ...
                        <div class="form-froup">
                           <div class="wrap-input100 validate-input" data-validate="Banner Title">
                              <input class="input100" type="text" name="reference"  value="{{ $details_db->reference}}" placeholder="Reference">
                              <span class="focus-input100"></span>
                           </div>
                        </div>
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                        <input type="hidden" name="banner_id" value="{{ $details_db->id }}" />
