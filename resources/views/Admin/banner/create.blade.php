                  ...
                  <div class="col-lg-12">
                     ...
                     <form class="contact100-form validate-form" action="{{ route('banner.store') }}" method="POST"
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Banner Slogan">
                           <input class="input100" type="text" name="slogan" placeholder="Banner Slogan">
                           <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="form-froup">
                              ...
                              <select class="form-control" name="reference" id="">
                                 ...
                                 @foreach ($page_list as $page)
                                    <option value="{{$page->_id}}" {{$page->name?'':'disabled'}}>{{$page->main_type}}->{{$page->name?$page->name:'Page name not set'}}</option>
                                 @endforeach  
                              </select>                               
                              @endif
