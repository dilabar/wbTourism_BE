...
<body id="page-top">
                ...
                <div class="container-fluid">
                  @include('Admin.layouts.message')
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{url('/admin/gallery/create')}}" class="btn btn-info" > <i class="fas fa-plus-circle"></i> Add New Gallery</a>
                    </div>
                     <!-- DataTales Example -->
	...
	dataTable=$('#dataTable').DataTable( {
        dom: 'Blfrtip',
          ...
          "initComplete":function(){
            ...
            $(document).on('click', '.btn-modal', function(){
             ...
             $('#confirm_action #gallery_id').val(value);
        ...
        $("#submit-btn").click(function(){
             ...
             var id=$('#confirm_action #gallery_id').val();
             var form = $(document.createElement('form'));
             var url = base_url+"/admin/gallery/delete/";
             console.log(url);
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Do you really want to <span id="op_type">delete</span> the Gallery <span id="item_name"></span> ?</p>
			</div>
