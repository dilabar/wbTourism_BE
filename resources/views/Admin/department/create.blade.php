            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="{{ url('/admin/department/list') }}" class="btn btn-info"> <i class="fas fa-list-ol"></i>
                            View Tender</a>
                    </div>
                    <div class="row">
                        <div class=" card col-lg-8 offset-lg-2">
                            ...
                            <form class="contact100-form validate-form" action="{{ route('gallery.store') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="wrap-input100 validate-input" data-validate="Tender Name/Title">
                                        <input class="input100 {{ $errors->has('name') ? 'form-control is-invalid' : '' }}" type="text" name="name" value="{{ @old('name')}}"
                                            placeholder="Tender Name/Title">
