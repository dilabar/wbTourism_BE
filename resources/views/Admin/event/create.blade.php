            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="{{ url('admin/event/list') }}" class="btn btn-info">View Event</a>
                    ...
                    <div class="row">
                        <div class=" card col-lg-8 offset-lg-2">
                            <div class="card-header">
                                <h6 class="m-0 font-weight-bold ">Upload Event</h6>
                            </div>
                            <form class="contact100-form validate-form" action="{{ route('event.store') }}"
