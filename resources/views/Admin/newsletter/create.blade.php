                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="card col-lg-8 offset-lg-2">
                            ...
                            <form class="contact100-form validate-form" action="{{ route('newsletter.store') }}"
                                method="POST" enctype="multipart/form-data">
                                <div class="card-body">

                                    <div class="wrap-input100 validate-input" data-validate="Newsletter No">
                                        <input class="input100 {{ $errors->has('letter_no') ? 'form-control is-invalid' : '' }}" type="text" name="letter_no" placeholder="Newsletter No">
                                        <span class="focus-input100"></span>
                                    </div>
                                    <div class="wrap-input100 validate-input" data-validate="Date">
                                        <input class="input100 {{ $errors->has('letter_date') ? 'form-control is-invalid' : '' }}" type="date" name="letter_date">
                                        <span class="focus-input100"></span>
                                    </div>
