...
<body id="page-top">
                ...
                <div class="container-fluid">
                  @include('Admin.layouts.message')
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{url('/admin/newsletter/create')}}" class="btn btn-info" > <i class="fas fa-plus-circle"></i> Add Newsletter</a>
                    </div>
                     <!-- DataTales Example -->
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Newsletter List</h6>
                        </div>
                        <div class="card-body">
	...
	dataTable=$('#dataTable').DataTable( {
        dom: 'Blfrtip',
          ...
          "initComplete":function(){
            ...
            $(".btn-modal").click(function(){
             ...
             $('#confirm_action #newsletter_id').val(value);
        ...
        $("#submit-btn").click(function(){
             ...
             var id=$('#confirm_action #newsletter_id').val();
             var form = $(document.createElement('form'));
             var url = base_url+"/admin/newsletter/delete/";
             console.log(url);
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Do you really want to <span id="op_type">delete</span> the Newsletter <span id="item_name"></span> ?</p>
			</div>
			<div class="modal-footer justify-content-center">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                <form id="confirm_action">
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                <input type="hidden" name="id" id="newsletter_id" value="" />
