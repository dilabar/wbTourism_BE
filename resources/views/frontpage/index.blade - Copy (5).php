...
<section   class="top-product pt-100 ">
    ...
    <div class="container">
                ...
                <div class="tours-slider top-style-two owl-carousel mb-30">
                  @foreach($top_ten_product as $top_ten)
                    ...
                    <div class="boxes">
                        <div class="grid_4">
                            <div class="figure">
                              <div ><img src="{{$top_ten->img}}" alt=""></div>
               ...
               <div class="row">
                @foreach($top_destination as $destination)
                  ...
                  <div class="col-lg-4 col-md-6 mb-4">
                     ...
                     <img class="img-fluid" src="{{$destination->img}}" alt="">
                ...
                <div id="wrapper">
                    <div class="content-holder">
                        <div class="full-height-wrap">
                           ...
                           $i=0;
                           @endphp
                            @foreach($event_list as $key=>$eventList)
                            <div class="hero-grid" style="float:left;width:33.3%;height:50%;position:relative;">
                                <div class="img-slider" id="slider{{$i}}">
                                   @foreach($eventList as $event)
                                    <div style="background-image: url('{{ asset('/assets/img/upload/events/' . $event->Media->thumbnail_image_path.'.'.$event->Media->extention) }}')">
      ...
      <!-- ************************************************************************ -->
      <!-- *********************************   tab design   ****************************** -->
      @if(count($section4_list)>0)
      <section id="autotab" class="tab-section mt-100">
         <div class="container">
            <div class="tab-bar">
               <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
               @foreach($section4_list as $section_item)
                  <li class="nav-item" role="presentation">
                     <button class="nav-link active" id="{{$section_item->tab_id}}-tab" data-bs-toggle="tab" data-bs-target="#{{$section_item->tab_id}}" type="button" role="tab" aria-controls="{{$section_item->tab_id}}" aria-selected="false">{{$section_item->name}} <span class="line"></span></button>
                  </li>
                  @endforeach
               </ul>
            </div>
            ...
            @foreach($section4_list as $section_item)
               <div class="tab-pane fade show active" id="{{$section_item->tab_id}}" role="tabpanel" aria-labelledby="{{$section_item->tab_id}}-tab">
                  <div class="row">
                     <div class="col-lg-6">
                        <div class="img-box">
                           <div class="box1">
