        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 ">
                <div class="tours-slider top-style-two owl-carousel mb-30">
                  ...
                  @php
                  $content = MongoGrid::prefix('fs_product')->getFileContent($top_ten->thumbnail_image_obj_id,0);
                  $document = MongoGrid::prefix('fs_product')->getFile($top_ten->thumbnail_image_obj_id);
            ...
            <div class="container pt-5 pb-3">
               ...
               <div class="row">
                @foreach($top_destination as $destination)
                  @php
                  $content = MongoGrid::prefix('fs_destination')->getFileContent($destination->thumbnail_image_obj_id,0);
                  $document = MongoGrid::prefix('fs_destination')->getFile($destination->thumbnail_image_obj_id);
                  $type=$document->contentType;
                  $img = 'data:' . $type . ';base64,' . base64_encode($content); 
                  @endphp
